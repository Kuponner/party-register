...
//SingUp
const facebookButtonUp = document.querySelector('#facebookLoginUp');

facebookButtonUp.addEventListener('click', async e => {
  e.preventDefault();
  
  //Pre loader
  document.getElementById("facebookLoginUp").innerHTML='<div class="spinner-grow text-primary"></div>';
