...
const googleButtonUp = document.querySelector("#googleSignup");

googleButtonUp.addEventListener("click", async (e) => {
  e.preventDefault();

  //Pre loader
  document.getElementById("googleSignup").innerHTML='<div class="spinner-grow text-primary"></div>';
